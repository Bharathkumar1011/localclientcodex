...
export default function InvestorOutreachPage() {
  ...
  // 4. Mutation: Update Remarks (New Feature)
                    ...
                    <TableRow key={inv.id}>
                      ...
                      <TableCell>
                        ...
                        <div className="flex flex-wrap gap-1 mt-2">
                           {displayContacts.length > 0 ? displayContacts.map((c: any) => (
                             <div key={c.id} className="flex items-center gap-1 text-[10px] bg-slate-100 px-2 py-0.5 rounded border">
                      ...
                      <TableCell>
                         <RemarkInput 
                           ...
                           onSave={(val) => remarksMutation.mutate({ investorId: inv.id, remarks: val })} 
                         />
                      </TableCell>
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end gap-1 flex-wrap">
                          <Button
                            ...
                            onClick={() => setLocation(`/investor-outreach/${leadId}/${inv.id}`)}
                          >
                            Manage Outreach
                          </Button>
                          {/* Email */}
