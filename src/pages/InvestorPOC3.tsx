...
// ✅ CONFIG FOR POC 3
const SLOT_INDEX = 2; 
const PAGE_TITLE = "Investor POC 3";
...
export default function InvestorPOC3() {
...
<div className="grid grid-cols-1 md:grid-cols-5 gap-2"></div>
  ...
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Manage and clean tertiary contact data for investors.</p>
      </div>
